        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<decimal>(type: "decimal(20,0)", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CoolUserId = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyClosings_CoolUsers_CoolUserId",
                        column: x => x.CoolUserId,
                        principalTable: "CoolUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<decimal>(type: "decimal(20,0)", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CoolUserId = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
                    BuyOnFridgePermission = table.Column<int>(type: "int", nullable: false),
                    BuyOnFridgePinCodeHash = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyClosingId = table.Column<decimal>(type: "decimal(20,0)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_CoolUsers_CoolUserId",
                        column: x => x.CoolUserId,
                        principalTable: "CoolUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_MonthlyClosings_MonthlyClosingId",
                        column: x => x.MonthlyClosingId,
                        principalTable: "MonthlyClosings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyClosings_CoolUserId",
                table: "MonthlyClosings",
                column: "CoolUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyClosings_Number_CoolUserId",
                table: "MonthlyClosings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CoolUserId",
                table: "Orders",
                column: "CoolUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_MonthlyClosingId",
                table: "Orders",
                column: "MonthlyClosingId");
